...
if __name__ == '__main__': 
    ...
    for CSV in CSV_NAME:
        ...
        R = Agent("R", data["r_x"], data["r_y"], data["time"], data["r_{theta}"], data["r_v"], data["r_{\omega}"], addnoise = True)
        H = Agent("H", data["h_x"], data["h_y"], data["time"], data["h_{theta}"], data["h_v"], data["h_{\omega}"], addnoise = True)
