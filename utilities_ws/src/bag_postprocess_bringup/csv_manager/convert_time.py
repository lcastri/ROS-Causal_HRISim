...
input_csv_path = "A2_traj_interp.csv"  # Replace with your input CSV file path
output_csv_path = "A2_traj_interp.csv"  # Replace with your desired output CSV file path
